...
* [vssetings file](/assets/images/ide/1/vs_font_color_setting.vssettings)
...
* 편집기상황에맞는메뉴.탐색.활성문서동기화  (ctrl + [, ctrl + s, 원래꺼 지우기) -> __( ```ctrl + [, ctrl + [``` )__
...
### Basic Visual
#### Etc
* 편집기상황에맞는메뉴.탐색.활성문서동기화  __( ```ctrl + [, ctrl + [``` )__
...
![visual setting](/assets/images/ide/1/3.png)
...
![visual setting](/assets/images/ide/1/2.png)
