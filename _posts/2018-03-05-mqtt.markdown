...
__메시지는 한번만 전달한다.__ Fire and Forget이라고도 한다. 즉 보내고 잊는다. 한번만 전달하지만 전달여부는 확인하지 않는 레벨이다.
...
<br/>
<span style="color:#466FC4; font-size:1.3em;">IoT (Sensor)</span>
...
<br/>
<span style="color:#466FC4; font-size:1.3em;">Message Push Server</span>
...
<br/>
<span style="color:#466FC4; font-size:1.3em;">MQTT Control Packet 구조</span>
...
<br/>
<span style="color:#466FC4; font-size:1.3em;">Fixed header</span>
...
<br/>
<span style="color:#466FC4; font-size:1.3em;">Variable header</span>
