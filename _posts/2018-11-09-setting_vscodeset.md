...
![prettier](/assets/images/setting/3/prettier.gif)
...
![SettingSync](/assets/images/setting/3/1.png)

2. Token 설명을 입력하고 gist를 체크한 뒤 토큰을 생성합니다.
![SettingSync](/assets/images/setting/3/2.png)

3. 생성된 토큰을 복사합니다.
![SettingSync](/assets/images/setting/3/3.png)
...
![SettingSync](/assets/images/setting/3/4.png)
