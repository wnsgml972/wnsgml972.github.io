...
![MQTT](/assets/images/mqtt/1/cmake.png)
...
![MQTT](/assets/images/mqtt/1/pthread.png)
...
![MQTT](/assets/images/mqtt/1/openssl.png)
...
![MQTT](/assets/images/mqtt/1/libwebsocket.png)
...
![MQTT](/assets/images/mqtt/1/mosquitto.png)

<br/>
* 완료 됐을 시 총 4개의 폴더가 ```c:\```에 있어야 함

![MQTT](/assets/images/mqtt/1/directory.png)
...
![MQTT](/assets/images/mqtt/1/cmake_build.png)

<br/>
* ```C\libtemp\libwebsockets-2.4.1\```의 위치에 __build Directory 생성__

![MQTT](/assets/images/mqtt/1/cmake_build0.png)

<br/>
* Cmake-gui 설정

![MQTT](/assets/images/mqtt/1/cmake_build2.png)

<br/>
* Configure를 클릭하여 Visual Studio 14 2015 선택, 사용하는 Visual Studio 버젼이 2017이면  Visual Studio 15 2017 선택

![MQTT](/assets/images/mqtt/1/cmake_build3.png)

<br/>
* 에러 창이 나온다면 ok 클릭

![MQTT](/assets/images/mqtt/1/cmake_build4.png)

<br/>
* ```CMAKE_INSTALL_PREFIX``` 를 ```C:\libtemp\libwebsockets-2.4.1``` 로 변경

![MQTT](/assets/images/mqtt/1/cmake_build5.png)

<br/>
* OpenSSL 경로 추가

![MQTT](/assets/images/mqtt/1/cmake_build6.png)

<br/>
* ```LWS_WITH_SSL``` 체크 해제 후 __Configure 클릭__

![MQTT](/assets/images/mqtt/1/cmake_build7.png)

<br/>
* Configure done 이 확인된 후 Generate 버튼을 클릭하여 프로젝트 생성

![MQTT](/assets/images/mqtt/1/cmake_build8.png)

<br/>
* Generate done 확인 후 Open Project클릭하여 프로젝트 Open

![MQTT](/assets/images/mqtt/1/cmake_build9.png)
...
![MQTT](/assets/images/mqtt/1/cmake_build10.png)

<br/>
* ```websocket.dll``` 이 생성되었는지 확인

![MQTT](/assets/images/mqtt/1/cmake_build11.png)
...
![MQTT](/assets/images/mqtt/1/mos9.png)
...
![MQTT](/assets/images/mqtt/1/mos10.png)
...
![MQTT](/assets/images/mqtt/1/mos20.png)
...
![MQTT](/assets/images/mqtt/1/mos19.png)
